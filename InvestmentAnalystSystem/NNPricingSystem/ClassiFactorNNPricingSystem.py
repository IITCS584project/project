...
class ClassicFactorNNPricingSystem:
    def __init__(self):
        pass
    ...
    def Init(self, feature_num :int):
        ...
        self.mOptimizer = optim.SGD(self.mModel.parameters(), lr=0.0002, momentum=0.9, weight_decay = 0.5)
...
def Main():
    ...
    solver = ClassicFactorNNPricingSystem()    
